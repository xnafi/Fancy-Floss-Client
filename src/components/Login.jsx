...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 bg-black my-10 text-white mx-auto">
            <h1 className="text-2xl text-center uppercase font-bold">Login</h1>
            <form onSubmit={handleLogin} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid flex flex-col">
                ...
                <button className="bg-white mx-auto p-3 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400 text-black font-bold items-center">Log in</button>
            </form>
